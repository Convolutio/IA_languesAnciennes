...
This tuple contains :
    ...
    - the CPU IntTensor with the lengths of the raw sequences (i.e. without their boundaries). The numpy format enables CPU optimisation for the indexing in the dynamic program. (shape = (C, B))

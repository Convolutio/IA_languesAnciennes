...
une chaîne de caractères, une fonction $f$ a déjà implicitement été déterminée pour
réaliser la tâche.
...
Mathématiquement, ce sont des composés d'applications non-linéaires et linéaires
...
Le neurone artificiel le plus élémentaire effectue la \textbf{somme pondérée}
